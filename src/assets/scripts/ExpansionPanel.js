...
const outgoingUrls = {
    ...
    'stobbermuehle' : 'https://www.google.de/travel/hotels/Buckow%20(M%C3%A4rkische%20Schweiz)/place/18096213436554349619?ap=KlQKEgkZAi6ZkUdKQBHsLzIVLCEsQBISCYWUHtDcSUpAERSfyBqqKixAGioKGxGAZ_0X6yUsQBlPS6Y0t0hKQAnQi3GAoPLAQBoGCLADEK8FJZqZUUEwAVqnAQoFCJYBEAAiA0VVUioWCgcI4w8QAhgPEgcI4w8QAhgQGAEgAVgBcgIIAooBVAoSCRkCLpmRR0pAEewvMhUsISxAEhIJhZQe0NxJSkARFJ_IGqoqLEAaKgobEYBn_RfrJSxAGU9LpjS3SEpACdCLcYCg8sBAGgYIsAMQrwUlmplRQZoBCBIGQnVja293ogETCgkvbS8wZjk5MmgSBkJ1Y2tvd5IBAiAB&g2lb=4181926%2C4208993%2C4209588%2C4225901%2C4207631%2C4215556%2C4219394%2C4220469&hl=en&gl=de&un=0&q=Buckow%20Unterkunft&rp=OAFAAA&ictx=1&hrf=CgUIlgEQACIDRVVSKhYKBwjjDxABGBkSBwjjDxABGBoYASABWAFyAggCigFUChIJGQIumZFHSkAR7C8yFSwhLEASEgmFlB7Q3ElKQBEUn8gaqiosQBoqChsRgGf9F-slLEAZT0umNLdISkAJ0ItxgKDywEAaBgiwAxCvBSWamVFBmgEIEgZCdWNrb3eiARMKCS9tLzBmOTkyaBIGQnVja293kgECIAE&tcfs=Ei0KCS9tLzBmOTkyaBIGQnVja293GhgKCjIwMTktMDEtMjUSCjIwMTktMDEtMjYYAiIYCgoyMDE5LTAxLTI1EgoyMDE5LTAxLTI2UgA',
      ...
      <div className={classes.root}>
        ...
        <ExpansionPanel expanded={expanded === 'panel1'} onChange={this.handleChange('panel1')} className={classes.panel}>
          ...
          <ExpansionPanelDetails>
            <div className="accomodation-expansion">
              ...
              <div className="row"><Add />Frühstück inklusive</div>
                <a href={outgoingUrls.bergschloesschen} target="_blank" rel="noopener noreferrer">
                  <img src={ImgStrandhotelBuckow} className="review-img" title="Google Bewertungen für Strandhotel Buckow" alt="Strandhotel Buckow Bewertungen" />
                </a>
            </div>
          </ExpansionPanelDetails>
        </ExpansionPanel>
        <ExpansionPanel expanded={expanded === 'panel9'} onChange={this.handleChange('panel9')} className={classes.panel}>
          <ExpansionPanelSummary expandIcon={<ExpandMoreIcon />}>
            <div className={classes.headingWrapper}>
              <div className={classes.heading}><DirectionsWalk />5min</div>
              <div className={classes.secondaryHeading}>Gasthaus Stobbermühle</div>
            </div>
          </ExpansionPanelSummary>
          <Divider />
          <ExpansionPanelDetails>
            <div className="accomodation-expansion">
              <div className="row"><Group /> ab 75€ pro Nacht</div>
                <a href={outgoingUrls.vierJahreszeiten} target="_blank" rel="noopener noreferrer">
                  <img src={ImgStobbermuehle} className="review-img" title="Google Bewertungen für Gasthaus Stobbermühle" alt="Gasthaus Stobbermühle Bewertungen" />
                </a>
            </div>
          </ExpansionPanelDetails>
        </ExpansionPanel>
        <ExpansionPanel expanded={expanded === 'panel2'} onChange={this.handleChange('panel2')} className={classes.panel}>
          ...
          <ExpansionPanelDetails>
            <div className="accomodation-expansion">
              ...
              <div className="row"><Group /> ab 75€ pro Nacht</div>
                <a href={outgoingUrls.vierJahreszeiten} target="_blank" rel="noopener noreferrer">
                  <img src={ImgVierJahreszeiten} className="review-img" title="Google Bewertungen für Hotel Vier Jahreszeiten" alt="Vier Jahreszeiten Bewertungen" />
                </a>
            </div>
          </ExpansionPanelDetails>
        </ExpansionPanel>
        ...
        <ExpansionPanelDetails>
          <div className="accomodation-expansion">
            ...
            <div className="row"><Add />Frühstück inklusive</div>
              <a href={outgoingUrls.hotelMaerkischeSchweiz} target="_blank" rel="noopener noreferrer">
                <img src={ImgHotelMaerkischeSchweiz} className="review-img" title="Google Bewertungen für Hotel Märkische Schweiz" alt="Hotel Maerkische Schweiz Bewertungen" />
              </a>
          </div>
        </ExpansionPanelDetails>
      </ExpansionPanel>
      <ExpansionPanel expanded={expanded === 'panel8'} onChange={this.handleChange('panel8')} className={classes.panel}>
      <ExpansionPanelSummary expandIcon={<ExpandMoreIcon />}>
        <div className={classes.headingWrapper}>
          <div className={classes.heading}><DirectionsWalk />10min</div>
          <div className={classes.secondaryHeading}>Bellevue Gastgeberei und Kreativhaus</div>
        </div>
      </ExpansionPanelSummary>
      <Divider />
      <ExpansionPanelDetails>
        <div className="accomodation-expansion">
          <div className="row"><Person /> 45€ pro Nacht</div>
          <div className="row"><Group /> 65€ pro Nacht</div>
          <div className="row"><Add />Frühstück für 7€ p.P. zubuchbar</div>
            <a href={outgoingUrls.gastgeberei} target="_blank" rel="noopener noreferrer">
              <img src={ImgBellevue} className="review-img" title="Google Bewertungen für Bellevue Gastgeberei" alt="Gastgeberei und Kreativhaus Bewertungen" />
            </a>
        </div>
      </ExpansionPanelDetails>
    </ExpansionPanel>
      <ExpansionPanel expanded={expanded === 'panel4'} onChange={this.handleChange('panel4')} className={classes.panel}>
        ...
        <ExpansionPanelDetails>
          <div className="accomodation-expansion">
            ...
            <div className="row"><Add />Frühstück inklusive</div>
            <a href={outgoingUrls.bergschloesschen} target="_blank" rel="noopener noreferrer">
              <img src={ImgBergschloesschen} className="review-img" title="Google Bewertungen für Hotel Bergschlösschen" alt="Berschloesschen Bewertungen" />
            </a>
          </div>
        </ExpansionPanelDetails>
      </ExpansionPanel>
      ...
      <ExpansionPanel expanded={expanded === 'panel5'} onChange={this.handleChange('panel5')} className={classes.panel}>
        ...
        <ExpansionPanelDetails>
          <div className="accomodation-expansion">
            ...
            <Button variant="contained" color="primary" className={classes.button} href="https://www.airbnb.de/rooms/23013478?location=Buckow%20M%C3%A4rkische%20Schweiz&check_in=2019-08-23&check_out=2019-08-25&s=88huQPYW&guests=4&adults=4" target="_blank" rel="noopener noreferrer">
              Zur Unterkunft
            </Button>
          </div>
        </ExpansionPanelDetails>
      ...
      <ExpansionPanel expanded={expanded === 'panel6'} onChange={this.handleChange('panel6')} className={classes.panel}>
        ...
        <ExpansionPanelDetails>
          <div className="accomodation-expansion">
            ...
            <Button variant="contained" color="primary" className={classes.button} href="https://www.airbnb.de/rooms/24483368?location=Buckow%20M%C3%A4rkische%20Schweiz&check_in=2019-08-23&check_out=2019-08-25&s=88huQPYW" target="_blank" rel="noopener noreferrer">
              Zur Unterkunft
            </Button>
          </div>
        </ExpansionPanelDetails>
      ...
      <ExpansionPanel expanded={expanded === 'panel7'} onChange={this.handleChange('panel7')} className={classes.panel}>
        ...
        <ExpansionPanelDetails>
          <div className="accomodation-expansion">
            ...
            <Button variant="contained" color="primary" className={classes.button} href="https://www.jugendherberge.de/jugendherbergen/buckow-608/portraet/" target="_blank" rel="noopener noreferrer">
              Zur Unterkunft
            </Button>
          </div>
        </ExpansionPanelDetails>
