    ...
    return (
      <div>
        <Card className={classes.card}>
          ...
          />
          <BrowserView viewClassName="smaller-image"><img src={scheuneBuckow2} className="imageHeader" alt="scheune-buckow"/></BrowserView>
          <MobileView><img src={scheuneBuckow} alt="scheune-buckow" /></MobileView>
          <CardContent>
            ...
            <List component="nav" className={classes.root}>
                ...
                <ListItem button>
                  ...
                  <div className="space-between align-center">
                    Dauer: Etwa 50min
                    <Tada>
                    <Button variant="contained" color="primary" className={classes.button} href="https://www.google.com/maps/dir//52.572327,14.072156/@52.572327,14.072156,14z?hl=de-DE/" target="_blank">
                      Route berechnen
                    </Button>
                    </Tada>
                  </div>
                ...
                <ListItem button>
                  ...
                  <div className="space-between align-center">
                    Dauer: Etwa 90min
                    <Tada>
                    <Button variant="contained" color="primary" className={classes.button} href="https://www.google.com/maps/dir//52.572327,14.072156/@52.5723334,14.0677786,16z/data=!3m1!4b1!4m2!4m1!3e3?hl=de-DE" target="_blank">
                      Route berechnen
                    </Button>
                    </Tada>
                    </div>
